-- Extend v_pending_cancellation_days to include RESCINDED PTO requests
-- Previously only CANCELLED was checked; RESCINDED (retroactive rescind) was silently excluded.
